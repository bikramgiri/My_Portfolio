        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="space-y-8 text-gray-300 order-2 lg:order-1">
            ...
            <p className="text-lg md:text-xl lg:text-2xl  leading-relaxed">
              ...
              I create innovative web solutions, explore AI/ML technologies, and share insights on my <a href="https://giribikram.com.np/" target="_blank" rel="noopener noreferrer" className="text-blue-400 font-semibold underline">Bikram&apos;s Blog</a>. 
            ...
            <div className="space-y-6 pt-2">
              <div className="flex items-center gap-4">
                ...
                <a href="https://mail.google.com/mail/u/0/?view=cm&fs=1&to=giribikram40@gmail.com" target="_blank" rel="noopener noreferrer" className="text-base md:text-lg lg:text-xl hover:text-blue-400 transition-colors duration-300">
              ...
              <div className="flex items-center gap-4">
                ...
                <a href="tel:98XXXXXXXX" className="text-base md:text-lg lg:text-xl hover:text-blue-400 transition-colors duration-300">
                  98XXXXXXXX
                </a>
              </div>
