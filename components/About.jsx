      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="space-y-8 text-gray-300 order-2 lg:order-1">
            <h3 className="text-3xl md:text-3xl lg:text-4xl font-extrabold text-blue-500">
              Hi, I'm Bikram Giri
            </h3>
            <p className="text-lg md:text-xl lg:text-2xl leading-relaxed">
              A <span className="text-blue-400 font-semibold">Web Developer</span> and{" "}
              <span className="text-blue-400 font-semibold">AI/ML Enthusiast</span> pursuing B.Sc. CSIT
              at Tribhuvan University. I create innovative web solutions, explore AI/ML technologies,
              and share insights on my{" "}
              <a
              ...
              . Passionate about <span className="text-blue-400 font-semibold">learning</span>,{" "}
              <span className="text-blue-400 font-semibold">collaboration</span>, and{" "}
              <span className="text-blue-400 font-semibold">solving real-world problems</span>, I aim to
            ...
            <div className="space-y-6 pt-2">
              <div className="flex items-center gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-base md:text-lg lg:text-xl hover:text-blue-400 transition-colors duration-300"
                >
