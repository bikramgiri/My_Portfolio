        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="bg-gradient-to-br from-blue-900/30 to-blue-950/60 backdrop-blur-md rounded-2xl md:rounded-2xl p-8 md:p-10 lg:p-12 border border-blue-800/50 shadow-xl hover:shadow-blue-500/5 transition-all duration-500">
            ...
            <p className="text-base sm:text-lg text-gray-300 mb-8 md:mb-12 leading-relaxed">
              I’m actively seeking new opportunities to collaborate on exciting
              projects. Whether you have a question or simply want to connect,
            ...
            <div className="flex gap-4 md:gap-6 mt-10 md:mt-14">
              ...
              <a
                href="https://x.com/bikram__giri/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 md:p-4 bg-blue-500/20 rounded-2xl hover:bg-blue-500/40 hover:scale-110 transition-all duration-300"
                aria-label="Twitter Profile of Bikram Giri"
              >
          ...
          <div className="bg-gradient-to-br from-blue-900/30 to-blue-950/60 backdrop-blur-md rounded-2xl md:rounded-2xl p-8 md:p-10 lg:p-12 border border-blue-800/50 shadow-xl hover:shadow-blue-500/5 transition-all duration-500">
            ...
            >
              ...
              {successMessage && (
                <p className="text-green-400 text-base md:text-lg text-center font-medium">
                  {successMessage}
                </p>
              )}
              {errorMessage && (
                <p className="text-red-600 text-base md:text-lg text-center font-medium">
                  {errorMessage}
                </p>
              )}
            </form>
