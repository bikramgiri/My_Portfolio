...
const Achievements = () => {
  ...
  const certifications = [
    ...
    },
    {
      ...
      cerurl:
        "https://drive.google.com/file/d/1bGkoznrNLCtqSM7gfRbE3oY7Ox_OqD-F/view",
      techs: ["AI", "ML", "Python"],
      description:
    ...
    },
    {
      ...
      cerurl:
        "https://drive.google.com/file/d/1VDwzy00mA-UUikv0KCgKYGf3tVHidgbO/view",
      techs: ["React.js"],
      description:
    ...
    },
    {
      ...
      cerurl:
        "https://drive.google.com/file/d/1a9XdpJMpuXqr4pThvYH_dqmtUprcsx2A/view",
    ...
    },
    {
      ...
      cerurl:
        "https://drive.google.com/file/d/1UGN7R-BDUBw4w85ePhhSe19XvVf_u5WU/view",
    ...
    },
    {
      ...
      cerurl:
        "https://drive.google.com/file/d/1h4Fy5YV3tBza1deZFnfxrqH2ujvvoFIm/view",
    ...
    },
    {
      ...
      cerurl:
        "https://drive.google.com/file/d/1jfVIaErbkDJQepf__STLalKrFeCyHFil/view",
      techs: ["Git", "GitHub"],
      description:
    ...
    },
    {
      ...
      cerurl:
        "https://drive.google.com/file/d/1f_UhpzCPX501RgMWxvYmNFERbC2TTFb-/view",
    ...
    },
    {
      ...
      cerurl:
        "https://drive.google.com/file/d/15PTm1XDGzS2qnT_IegkRjAr6SGQiaxQE/view",
    ...
    },
    {
      ...
      cerurl:
        "https://drive.google.com/file/d/1aFEWhOdJk4siE2_8Ktdb_iTYSJ9C7DyW/view",
    ...
    },
    {
      ...
      cerurl:
        "https://drive.google.com/file/d/1qDutLUZlRPo3aNaf2d2N1Yrvw9dxwAM-/view",
      techs: ["SEO"],
      description:
    ...
    },
    {
      ...
      cerurl:
        "https://drive.google.com/file/d/1jlYjMy4mUzfu67Xq1OkthXJf2Gss0lDT/view",
          ...
          >
            ...
            <div className="overflow-y-auto max-h-[90vh] scrollbar-thin scrollbar-thumb-blue-600 scrollbar-track-gray-800">
              ...
              <div className="px-6 md:px-6 pb-8 space-y-6">
                ...
                <a
                  href={selectedCert.cerurl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-2 py-4 md:py-5 px-6 border border-blue-700 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold text-base sm:text-lg md:text-xl rounded-xl shadow-md hover:shadow-blue-500/50 hover:scale-102 transition-all duration-300"
                >
