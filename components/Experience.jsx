...
import { ExternalLink, Calendar, Play, BookOpen } from "lucide-react";
...
const Experience = () => {
  ...
  return (
    <section
      id="experience"
      className="min-h-screen bg-gradient-to-br bg-gray-900 py-12 sm:py-16 md:py-20 px-6"
    >
                ...
                <div className="group bg-white/5 backdrop-blur-xl rounded-3xl p-6 sm:p-8 md:p-10 border border-blue-800/30 hover:border-blue-600/25 transition-all duration-500 shadow-md hover:shadow-xl hover:shadow-blue-500/10">
                  ...
                  <div className="space-y-4">
                    {experience.responsibilities.map((responsibility, idx) => (
                      <div
                        key={idx}
                        className="flex items-start gap-4 p-4 bg-blue-500/10 rounded-2xl hover:bg-blue-500/15 transition-colors"
                      >
