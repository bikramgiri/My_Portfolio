...
const Navbar = () => {
  ...
  const handleLinkClick = (e, path, isExternal = false) => {
  ...
  return (
    <>
      {/* Navbar */}
      <header className="sticky top-0 z-50 bg-gray-900/95 backdrop-blur-xl border-b border-blue-900/60 shadow-xl">
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="absolute right-0 top-0 h-full w-80 max-w-[60vw] bg-gray-900/95 shadow-xl overflow-y-auto">
