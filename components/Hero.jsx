      ...
      <div className="max-w-7xl mx-auto w-full mb-18 md:mb-24">
        <div className="flex flex-col lg:flex-row items-center gap-10 xl:gap-16">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6 md:space-y-7">
            {/* Semantic H1 for Search Engines (Bikram Giri, Bikram) */}
            <h1 className="sr-only">Bikram Giri – Web Developer & AI/ML Enthusiast Portfolio</h1>
            ...
            >
              ...
              <span
                className={`inline-block w-1 h-[1em] ml-1 rounded-sm ${
              ...
              <div className="flex flex-wrap justify-center lg:justify-start items-center gap-4 sm:gap-4 md:gap-4">
                {[
                  ...
                  <a
                    ...
                    aria-label={`Connect with Bikram Giri on ${social.label}`}
                  >
                    <social.icon
